...
export default function Footer() {
  ...
  </div><div className="container footer-social"><div><Link href="/social"><strong>Connect with Divya Tara ↗</strong></Link><p>Our social media and contact links, all in one place.</p></div></div><div className="footer-bottom"><div className="container">© {new Date().getFullYear()} Divya Tara Enterprises. All rights reserved.</div></div></footer>;
}
